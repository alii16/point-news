...
import com.example.pointnews.ui.WebViewActivity;

import com.example.pointnews.ui.health.HealthFragment;
import com.example.pointnews.ui.home.HomeFragment;
import com.example.pointnews.ui.tech.TechFragment;
import com.example.pointnews.ui.search.SearchFragment;
import com.example.pointnews.ui.entertainment.EntertainmentFragment;
...
public class MainActivity extends AppCompatActivity implements NewsAdapter.OnItemClickListener {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if (itemId == R.id.nav_github) {
                    ...
                    shareIntent.putExtra(Intent.EXTRA_TEXT, "Dapatkan berita terkini dengan GoNews App: https://drive.google.com/file/d/1IBuRkbUDfLGG9e_AA6hjpf2TgotjjhpS/view?usp=drive_link");
    ...
    public void onItemClick(Article article) {
        if (article.getUrl() != null && !article.getUrl().isEmpty()) {
            android.util.Log.d("NewsClick", "Opening URL: " + article.getUrl());
